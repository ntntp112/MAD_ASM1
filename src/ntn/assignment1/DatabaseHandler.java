...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String TBL_GROUP_TITLE = "titile";
    private static final String TBL_GROUP_REMOVE = "remove";
    ...
    public void addGroup(DTO_Group input) {
        ...
        values.put(TBL_GROUP_REMOVE, input.isRemove());
    ...
    public DTO_Group getGroup(String id) {
        ...
        Cursor cursor = db.query(TABLE_GROUP, new String[]{TBL_GROUP_ID,
            TBL_GROUP_TITLE}, TBL_GROUP_ID + "=? and " + TBL_GROUP_REMOVE + "=false",
    ...
    public List<DTO_Group> getGroups() {
        ...
        String selectQuery = "SELECT  * FROM " + TABLE_GROUP + " WHERE " + TBL_GROUP_REMOVE + "=false";
